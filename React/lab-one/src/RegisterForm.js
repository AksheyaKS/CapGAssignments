    ...
    render() {
        ...
        return (   
            ...
            <form onSubmit={this.handleSubmit}>
                <label>Product Id:<input type="text" name="productid" value={this.state.productid} onChange={this.handleInputChange}/>
                </label><br></br><br></br>

                <label>Product Name:<input type="text" name="productname" value={this.state.productname} onChange={this.handleInputChange}/>
                </label><br></br><br></br>

                <label>Product Cost:<input type="text" name="productcost" value={this.state.productcost} onChange={this.handleInputChange}/>
                </label><br></br><br></br>
